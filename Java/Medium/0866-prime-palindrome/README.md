<h2><a href="https://leetcode.com/problems/prime-palindrome/solutions/">866. Prime Palindrome</a></h2><h3>Medium</h3><hr><p>Given an integer n, return <em>the smallest <strong>prime palindrome</strong> greater than or equal to </em><code>n</code>.</p>
