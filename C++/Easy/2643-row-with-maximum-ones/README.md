<h2><a href="https://leetcode.com/problems/row-with-maximum-ones/solutions/8230032/veryyy-easyyy-code-on2-time-and-o1-space-rptv/">2643. Row With Maximum Ones</a></h2><h3>Easy</h3><hr><p>Given a <code>m x n</code> binary matrix <code>mat</code>, find the <strong>0-indexed</strong> position of the row that contains the <strong>maximum</strong> count of <strong>ones,</strong> and the number of ones in that row.</p>
