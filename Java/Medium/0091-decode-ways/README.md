<h2><a href="https://leetcode.com/problems/decode-ways/solutions/">91. Decode Ways</a></h2><h3>Medium</h3><hr><p>You have intercepted a secret message encoded as a string of numbers. The message is <strong>decoded</strong> via the following mapping:</p>
